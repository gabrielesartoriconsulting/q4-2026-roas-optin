/* ==========================================================================
   Q4 2026 ROAS — OPT-IN
   countries.js — elenco prefissi internazionali (ISO alpha-2, dial code, nome).
   Estratto dal vecchio opt-in Q2 e reso statico: nessuna libreria esterna,
   nessuno sprite di bandiere da scaricare (le bandiere sono emoji).
   Formato: ["CC", "dialCode", "Nome"]
   ========================================================================== */
